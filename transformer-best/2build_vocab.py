...
TOKENIZED_DIR = Path("E:/MIDI_GENERATOR/transformer-best/TokenizedWithChords")
VOCAB_PATH = Path("E:/MIDI_GENERATOR/transformer-best/vocab.json")
VOCAB_REVERSE_PATH = Path("E:/MIDI_GENERATOR/transformer-best/vocab_reverse.json")
